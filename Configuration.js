...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "ELA T Temperature sensor", endpointType.temperatureSensor);
  endpoints.addEndpoint("2", "ELA T PROBE Temperature sensor", endpointType.temperatureSensor);
