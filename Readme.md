...
# Parsing + Configuration Script – RUTX11 - Rev. A

This **Parsing + Configuration** script is designed for the **RUTX11** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – RUTX11 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **RUTX11** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
